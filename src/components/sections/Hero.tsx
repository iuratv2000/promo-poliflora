    ...
    <section id="top" className="relative overflow-hidden">
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 py-20 md:grid-cols-2 md:py-28">
        <div className="text-center md:text-left">
          <Badge className="mb-6 h-auto animate-in fade-in slide-in-from-bottom-2 px-3 py-1.5 text-sm font-semibold tracking-wide uppercase duration-500">
            {site.hero.eyebrow}
          </Badge>
          <h1 className="text-4xl text-foreground animate-in fade-in slide-in-from-bottom-3 duration-500 md:text-5xl lg:text-6xl">
            {site.hero.title}
          </h1>
          <p className="mx-auto mt-5 max-w-xl text-lg text-muted-foreground animate-in fade-in slide-in-from-bottom-3 duration-700 md:mx-0">
            {subtitleBefore}
        ...
        <div className="flex justify-center animate-in fade-in zoom-in-95 duration-700 md:justify-end">
          <div className="hero-jar-visual">
            <img
              ...
              className="hero-jar h-auto w-64 drop-shadow-xl md:w-96"
              width={375}
              height={495}
            />
          </div>
